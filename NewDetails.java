...
public class NewDetails extends Fragment implements IFetchCurrentLocation {
    ...
    String curdate1, A, Date, content1 = "New", timevalue1 = "", o_ = "", t_ = "", w1_ = "", w2_ = "", ID1;
    ListView tasklist;
    DBOperation db;
    TextView comment;
    int count = 0;
...
//                System.out.println(formatend2.format(enddate11));
                ...
                //System.out.println("apptypefromnew:"+getAlldataList.get(position).get("apptype"));
...
//        base.delete(UPDATEPARTY, null, null);
//        SQLiteDatabase base1 = db.getWritableDatabase();
//        base1.delete(POSTDOC, null, null);
//        System.out.println("party,post dbs deleted");
        if (GenericMethods.value.equals("true")) {
//            System.out.println("from true if");
            getAlldataList = db.getAllNewList1(db);
            // System.out.println("from true if");
            for (int i = 0; i < db.getAllNewList1(db).size(); i++) {


                reportkey.add(db.getAllNewList1(db).get(i).get("rkey"));
